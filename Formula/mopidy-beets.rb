class MopidyBeets < Formula
  ...
  desc "Beets backend for the Mopidy music server"
  homepage "https://github.com/mopidy/mopidy-beets"
  url "https://files.pythonhosted.org/packages/ca/77/84b717454140173775688ab135e07479c6bc35bccb96a42e9e0d13da833d/mopidy_beets-5.0.0.tar.gz"
